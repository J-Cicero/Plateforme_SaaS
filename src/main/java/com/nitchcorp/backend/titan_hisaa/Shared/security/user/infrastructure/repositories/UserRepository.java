package com.nitchcorp.backend.titan_hisaa.Shared.security.user.infrastructure.repositories;
...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT u FROM User u WHERE u.actif = :isActive")
    ...
    @Query(
            "SELECT u FROM User u WHERE LOWER(u.phone) LIKE LOWER(CONCAT('%', :phoneNumber, '%'))")
